...
#include "ArenaInputUserSettings.generated.h"

/** 
 * Custom settings class for any input related settings for the Arena game.
 * This will be serialized out at the same time as the Arena Shared Settings and is
 * compatible with cloud saves through by calling the "Serialize" function.
 */
UCLASS()
class ARENA_API UArenaInputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class ARENA_API UArenaPlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
