...
#include "ArenaSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class UArenaSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UArenaSettingValueDiscrete_Resolution();
