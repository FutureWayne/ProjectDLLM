...
#include "ArenaSettingValueDiscreteDynamic_AudioOutputDevice.generated.h"
...
UCLASS()
class UArenaSettingValueDiscreteDynamic_AudioOutputDevice : public UGameSettingValueDiscreteDynamic
{
	GENERATED_BODY()
	
public:

	virtual ~UArenaSettingValueDiscreteDynamic_AudioOutputDevice() = default;
