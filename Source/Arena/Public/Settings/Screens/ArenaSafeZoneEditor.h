...
#include "ArenaSafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class UArenaSafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UArenaSafeZoneEditor(const FObjectInitializer& Initializer);
