...
#include "ArenaBrightnessEditor.generated.h"
...
UCLASS(Abstract)
class UArenaBrightnessEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UArenaBrightnessEditor(const FObjectInitializer& Initializer);
