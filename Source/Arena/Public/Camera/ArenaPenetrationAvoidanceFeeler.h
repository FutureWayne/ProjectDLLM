...
#include "ArenaPenetrationAvoidanceFeeler.generated.h"

/**
 * Struct defining a feeler ray used for camera penetration avoidance.
 */
USTRUCT()
struct FArenaPenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	FArenaPenetrationAvoidanceFeeler()
	...
	FArenaPenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
