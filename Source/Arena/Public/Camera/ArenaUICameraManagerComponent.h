...
#include "ArenaUICameraManagerComponent.generated.h"

class AArenaPlayerCameraManager;
...
UCLASS( Transient, Within=ArenaPlayerCameraManager )
class UArenaUICameraManagerComponent : public UActorComponent
{
	GENERATED_BODY()

public:
	static UArenaUICameraManagerComponent* GetComponent(APlayerController* PC);

public:
	UArenaUICameraManagerComponent();	
