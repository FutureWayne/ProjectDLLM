...
#include "ArenaCameraMode.h"
#include "Curves/CurveFloat.h"
#include "ArenaPenetrationAvoidanceFeeler.h"
#include "DrawDebugHelpers.h"
#include "ArenaCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * UArenaCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class UArenaCameraMode_ThirdPerson : public UArenaCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FArenaPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
