...
public:	
	...
	void BroadcastEliminationMessage(AActor* DamageInstigator, const AActor* DamageCauser, const FGameplayEffectSpec& DamageEffectSpec, float DamageMagnitude) const;
