...
#include "ArenaGamePhaseAbility.generated.h"

/**
 * UArenaGamePhaseAbility
 *
 * The base gameplay ability for any ability that is used to change the active game phase.
 */
UCLASS(Abstract, HideCategories = Input)
class ARENA_API UArenaGamePhaseAbility : public UArenaGameplayAbility
{
	GENERATED_BODY()
	
public:
	UArenaGamePhaseAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Arena|Game Phase")
