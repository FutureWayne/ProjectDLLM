...
#include "Settings/CustomSettings/ArenaSettingValueDiscrete_Language.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ArenaSettingValueDiscrete_Language)

#define LOCTEXT_NAMESPACE "Arena"

static const int32 SettingSystemDefaultLanguageIndex = 0;

UArenaSettingValueDiscrete_Language::UArenaSettingValueDiscrete_Language()
{
}

void UArenaSettingValueDiscrete_Language::OnInitialized()
{
	Super::OnInitialized();
...
void UArenaSettingValueDiscrete_Language::StoreInitial()
{
	// ?
}

void UArenaSettingValueDiscrete_Language::OnApply()
{
...
void UArenaSettingValueDiscrete_Language::ResetToDefault()
{
	SetDiscreteOptionByIndex(SettingSystemDefaultLanguageIndex);
}

void UArenaSettingValueDiscrete_Language::RestoreToInitial()
{
	if (UArenaSettingsShared* Settings = CastChecked<UArenaLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
void UArenaSettingValueDiscrete_Language::SetDiscreteOptionByIndex(int32 Index)
{
	if (UArenaSettingsShared* Settings = CastChecked<UArenaLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
int32 UArenaSettingValueDiscrete_Language::GetDiscreteOptionIndex() const
{
	if (const UArenaSettingsShared* Settings = CastChecked<UArenaLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
TArray<FText> UArenaSettingValueDiscrete_Language::GetDiscreteOptions() const
{
