...
UGameSettingCollection* UArenaGameSettingRegistry::InitializeAudioSettings(UArenaLocalPlayer* InLocalPlayer)
{
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UArenaSettingsLocal>()->GetOverallVolume());
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UArenaSettingsLocal>()->GetMusicVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UArenaSettingsLocal>()->GetSoundFXVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UArenaSettingsLocal>()->GetVoiceChatVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		// 			Setting->SetDefaultValue(GetDefault<UArenaSettingsShared>()->GetSubtitlesEnabled());
		//
		...
		// 			Setting->SetDefaultValue(GetDefault<UArenaSettingsShared>()->GetSubtitlesTextSize());
		...
		// 			Setting->SetDefaultValue(GetDefault<UArenaSettingsShared>()->GetSubtitlesTextColor());
		...
		// 			Setting->SetDefaultValue(GetDefault<UArenaSettingsShared>()->GetSubtitlesTextBorder());
		...
		// 			Setting->SetDefaultValue(GetDefault<UArenaSettingsShared>()->GetSubtitlesBackgroundOpacity());
		...
		//----------------------------------------------------------------------------------
		{
			UArenaSettingValueDiscreteDynamic_AudioOutputDevice* Setting = NewObject<UArenaSettingValueDiscreteDynamic_AudioOutputDevice>();
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UArenaSettingsShared>()->GetAllowAudioInBackgroundSetting());
		
			Setting->AddEnumOption(EArenaAllowBackgroundAudioSetting::Off, LOCTEXT("EArenaAllowBackgroundAudioSetting_Off", "Off"));
			Setting->AddEnumOption(EArenaAllowBackgroundAudioSetting::AllSounds, LOCTEXT("EArenaAllowBackgroundAudioSetting_AllSounds", "All Sounds"));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UArenaSettingsLocal>()->IsHeadphoneModeEnabled());
		
			Setting->AddEditCondition(MakeShared<FWhenCondition>(
				[](const ULocalPlayer*, FGameSettingEditableState& InOutEditState)
				{
					if (!GetDefault<UArenaSettingsLocal>()->CanModifyHeadphoneModeEnabled())
					{
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UArenaSettingsLocal>()->IsHDRAudioModeEnabled());
