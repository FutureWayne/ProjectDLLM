...
void UIndicatorDescriptor::SetIndicatorManagerComponent(UArenaIndicatorManagerComponent* InManager)
{
...
{
	if (UArenaIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
