...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ArenaVerbMessageHelpers)


//////////////////////////////////////////////////////////////////////
// FArenaVerbMessage

FString FArenaVerbMessage::ToString() const
{
...
APlayerState* UArenaVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UArenaVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters UArenaVerbMessageHelpers::VerbMessageToCueParameters(const FArenaVerbMessage& Message)
{
...
FArenaVerbMessage UArenaVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FArenaVerbMessage Result;
